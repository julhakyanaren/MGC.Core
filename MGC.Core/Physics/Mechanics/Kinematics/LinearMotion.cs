namespace MGC.Physics.Mechanics.Kinematics
{
    ...
    /// <item>
    /// <description>
    /// <see cref="FreeFallDistance(double, double)"/> uses <see cref="Constants.StandartGravity"/> as the constant
    ...
    public static class LinearMotion
    {
        ...
        /// <remarks>
        /// Uses <see cref="Constants.StandartGravity"/> as g (m/s²). Sign and axis direction are defined by the caller.
        /// </remarks>
        public static double FreeFallDistance(double time, double v0 = 0)
        {
            return v0 * time + Constants.StandartGravity * System.Math.Pow(time, 2) / 2.0;
        }
